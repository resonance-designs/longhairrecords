...
<head>
	...
	<meta name="facebook-domain-verification" content="xhopc6mho6d0nn6i3rydw227m0t03m" />
	<?php
		elegant_description();
		elegant_keywords();
		elegant_canonical();
		...
		*/
		...
		$childtheme_directory_uri = get_stylesheet_directory_uri();
	?>
	...
	?>
			...
			<div class="et_slide_in_menu_container">
				...
				<?php if ( false !== et_get_option( 'show_search_icon', true ) || is_customize_preview() ) : ?>
					...
					<form role="search" method="get" class="et-search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
						<?php
							printf( '<input type="search" class="et-search-field" placeholder="%1$s" value="%2$s" name="s" title="%3$s" /><input type="hidden" name="post_type" value="product" />',
		...
		<?php ob_start(); ?>
			<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
				...
				<div id="lh-soundcloud-playlist">
					<a href="https://soundcloud.com/longhairrecords" target="_blank">
						<img src="<?php echo $childtheme_directory_uri . '/imgs/soundcloud-32x32.png'; ?>" alt="Tune In On SoundCloud"><span>Tune In On SoundCloud</span>
						<svg width="20px" height="20px" viewBox="0 0 24 24">
							<g id="external_link" stroke="#FF5500" stroke-width="1.5" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
